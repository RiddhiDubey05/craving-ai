...
export default function HomePage({ userCity, userPosition, onSearch, onViewStories, onCookChat }) {
  ...
  const handleRouteSelect = (routeObj) => {
    ...
    window.dispatchEvent(new CustomEvent('frog-speak', { detail: `Starting navigation to ${routeObj.name} by ${routeObj.mode}. Let's go!` }));
  ...
  return (
    <div style={{ width: '100vw', overflowX: 'hidden', position: 'relative', background: '#FFF6EC' }}>
      ...
      {/* Moving Parallax Background - Fixed Height Issue */}
      ...
      <div style={{ position: 'relative', zIndex: 10 }}>
        ...
        {/* Search Bar positioned to overlap the Hero and Trending section */}
        <MassiveSearch 
          onSearch={onSearch} 
          onSubmitSearch={() => {
        ...
        {/* Zomato/Swiggy Trending based on Location */}
        <TrendingFoods userCity={userCity} onCookChat={onCookChat} />
        
        {/* Interactive Cultural Representations */}
        <CuisineCategories userCity={userCity} onCookChat={onCookChat} />

        {/* Phase 25: The 3D Chef Guide & The Map */}
        ...
        {/* Phase 16: The New Explore Nearby Module */}
